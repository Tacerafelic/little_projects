...
title_font = pygame.font.SysFont("Retro", 40)
score_font = pygame.font.SysFont("Ubuntu", 40)

PINK = (180, 130, 134)
DARK_PINK = (87, 64, 66)  # 132, 96, 99
...
class Food:
    ...
    def draw(self):
        ...
        # pygame.draw.rect(screen, DARK_PINK, food_rect)
...
class Game:
    ...
    def update(self):
        if self.state == "RUNNING":
            ...
            self.check_collision_with_snake()
...
pygame.display.set_caption("Reputation")

clock = pygame.time.Clock()


food_surface = pygame.image.load(
    "C:/Users/victo/Documents/Python_code/games/Graphics/heart.png"
)
...
while True:
    ...
    game.draw()
    title_surface = title_font.render("Retro Snake", True, DARK_PINK)
    score_surface = score_font.render(str(game.score), True, DARK_PINK)
